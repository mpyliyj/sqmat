...
cm1xg4c01a = latt.kick("cm1xg4c01a",L=0.0,hkick=0.0,vkick=0.0)
cm1xg4c01b = latt.kick("cm1xg4c01b",L=0.0,hkick=0.0,vkick=0.0)
cm1xg4c30a = latt.kick("cm1xg4c30a",L=0.0,hkick=0.0,vkick=0.0)
cm1xg4c30b = latt.kick("cm1xg4c30b",L=0.0,hkick=0.0,vkick=0.0)
cm1yg4c01a = latt.kick("cm1yg4c01a",L=0.0,hkick=0.0,vkick=0.0)
cm1yg4c01b = latt.kick("cm1yg4c01b",L=0.0,hkick=0.0,vkick=0.0)
cm1yg4c30a = latt.kick("cm1yg4c30a",L=0.0,hkick=0.0,vkick=0.0)
cm1yg4c30b = latt.kick("cm1yg4c30b",L=0.0,hkick=0.0,vkick=0.0)
fh1g1c02a = latt.kick("fh1g1c02a",L=0.0,hkick=0.0,vkick=0.0)
fh2g1c30a = latt.kick("fh2g1c30a",L=0.0,hkick=0.0,vkick=0.0)
fl1g1c01a = latt.kick("fl1g1c01a",L=0.0,hkick=0.0,vkick=0.0)
fl2g1c01a = latt.kick("fl2g1c01a",L=0.0,hkick=0.0,vkick=0.0)
fm1g4c01a = latt.kick("fm1g4c01a",L=0.0,hkick=0.0,vkick=0.0)
fm1g4c30a = latt.kick("fm1g4c30a",L=0.0,hkick=0.0,vkick=0.0)
